                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="kra-tab-content">
                            ...
                            <?php require_once BASE_PATH . '/php/includes/local_evaluator/local_eval_a.php'; ?> 
                            <!-- Tab 2: Criterion B: Curriculum & Material Development -->
                            <?php require_once BASE_PATH . '/php/includes/local_evaluator/local_eval_b.php'; ?> 
                            <!-- Tab 3: Criterion C: Thesis & Mentorship Services -->
                            <?php require_once BASE_PATH . '/php/includes/local_evaluator/local_eval_c.php'; ?> 
                        </div>
                    </div>
