...
<h4 class="mb-4 pb-2 border-bottom border-3 border-success"><strong>CRITERION C - QUALITY OF EXTENSION SERVICES (MAX = 20 POINTS)</strong></h4>
    
    <h5><strong>CLIENT SATISFACTION RATING:</strong> Enter the average rating received by the faculty per semester.<br>  
    For newly appointed faculty from private HEI, LUCs, TESDA/DepEd schools who decide to proceed with the evaluation, 
    enter "0" for semesters with no client satisfaction rating.
    </h5>
    ...
    <form id="criterion-c-form" enctype="multipart/form-data">
        ...
        <input type="hidden" id="request_id" name="request_id" value="" readonly>
            ...
            <div class="col-12 mt-5">
                <h5 class="mb-4 pb-2 border-bottom border-2 border-success">CLIENT SATISFACTION RATING FOR OUTREACH AND EXTENSION PROJECTS</h5>
