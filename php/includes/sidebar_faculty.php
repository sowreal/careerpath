    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2"> 
            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link <?php echo ($activePage == 'CPT') ? 'active' : ''; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="career_progress_tracking/career_progress_teaching.php" class="nav-link <?php echo ($activePage == 'CPT_Teaching') ? 'active' : ''; ?>">
                                <i class="nav-icon bi bi-journal-text"></i> 
                                <p>Teaching</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="career_progress_tracking/career_progress_research.php" class="nav-link <?php echo ($activePage == 'CPT_Research') ? 'active' : ''; ?>">
                                <i class="nav-icon bi bi-journal-medical"></i> 
                                <p>Research, Innovation, and Creative Works</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="career_progress_tracking/career_progress_extension.php" class="nav-link <?php echo ($activePage == 'CPT_Extension') ? 'active' : ''; ?>">
                                <i class="nav-icon bi bi-people"></i>
                                <p>Extension Services</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="career_progress_tracking/career_progress_professional.php" class="nav-link <?php echo ($activePage == 'CPT_Professional') ? 'active' : ''; ?>">
