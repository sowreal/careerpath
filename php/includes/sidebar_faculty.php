    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2"> 
            ...
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview <?php echo $isCPTActive ? 'menu-open' : ''; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item ms-3">
                            <a href="php/dashboard/career_progress_tracking/career_progress_request.php" class="nav-link <?php echo ($activePage == 'CPT_Request') ? 'active' : ''; ?>">
                                <i class="nav-icon bi bi-file-earmark-text"></i> 
                                <p>Request Form</p>
                            </a>
                        </li>
                        <li class="nav-item ms-3">
                            <a href="php/dashboard/career_progress_tracking/career_progress_teaching.php" class="nav-link <?php echo ($activePage == 'CPT_Teaching') ? 'active' : ''; ?>">
                                <i class="nav-icon bi bi-journal-text"></i> 
                                <p>Teaching</p>
                            </a>
                        </li>
                        <li class="nav-item ms-3">
                            <a href="php/dashboard/career_progress_tracking/career_progress_research.php" class="nav-link <?php echo ($activePage == 'CPT_Research') ? 'active' : ''; ?>">
                                <i class="nav-icon bi bi-journal-medical"></i> 
                                <p>Research, Innovation, and Creative Works</p>
                            </a>
                        </li>
                        <li class="nav-item ms-3">
                            <a href="php/dashboard/career_progress_tracking/career_progress_extension.php" class="nav-link <?php echo ($activePage == 'CPT_Extension') ? 'active' : ''; ?>">
                                <i class="nav-icon bi bi-people"></i>
                                <p>Extension Services</p>
                            </a>
                        </li>
                        <li class="nav-item ms-3">
                            <a href="php/dashboard/career_progress_tracking/career_progress_professional.php" class="nav-link <?php echo ($activePage == 'CPT_Professional') ? 'active' : ''; ?>">
                ...
                <li class="nav-item"> <a href="php/dashboard/performance_summary_report.php" class="nav-link <?php echo ($activePage == 'PSR') ? 'active' : ''; ?>"> <i class="nav-icon bi bi-bar-chart"></i>
                        <p><strong>Performance Summary Reports</strong>
                        </p>
                    </a>
                </li>
                
                <li class="nav-item"> <a href="php/dashboard/document_management.php" class="nav-link <?php echo ($activePage == 'Documents') ? 'active' : ''; ?>"> <i class="nav-icon bi bi-folder"></i>
                        <p><strong>Document Management</strong></p>
                    </a>
                </li>

                <li class="nav-item"> <a href="php/dashboard/notifications.php" class="nav-link <?php echo ($activePage == 'Notifs') ? 'active' : ''; ?>"> <i class="nav-icon bi bi-bell"></i>
                ...
                <li class="nav-item"> <a href="php/dashboard/opportunities.php" class="nav-link <?php echo ($activePage == 'Opportunities') ? 'active' : ''; ?>"> <i class="nav-icon bi bi-briefcase"></i>
                        <p><strong>Job/Promotion Opportunities</strong>
                        </p>
                    </a>
                </li>

                <li class="nav-item"> <a href="php/dashboard/resources_training.php" class="nav-link <?php echo ($activePage == 'Training') ? 'active' : ''; ?>"> <i class="nav-icon bi bi-book"></i>
